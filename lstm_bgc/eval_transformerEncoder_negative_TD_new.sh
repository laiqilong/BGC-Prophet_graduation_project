...
nohup python -u ./transformer_BGC_TD/eval.py \
    ...
    --datasetPath ./data/BGC_negative_test_dataset.csv \
    --max_len 128 --nhead 4 --num_encoder_layers 6 --dropout 0.5 \
    --batch_size 32 --name negative_transformerEncoder_TD_new_dataset_new\
    ...
    >nohup_eval_transformerEncoder_new_dataset_negative_TD_new.out &
