...
nohup python -u ./transformer_BGC_TD/eval.py \
    ...
    --datasetPath ./data/imgABC_augmentation.csv \
    --max_len 128 --nhead 4 --num_encoder_layers 6 --dropout 0.5 \
    --batch_size 32 --name img_abc_transformerEncoder_TD_augmentation_dataset\
    ...
    >nohup_eval_transformerEncoder_img_abc_TD_augmentation_dataset.out &