...
nohup python -u ./lstm_bgc_everygene/eval.py \
    ...
    --datasetPath /home/yaoshuai/tools/BGC_labels_pred/lstm_bgc/data/imgABC_augmentation.csv \
    --max_len 128 --hidden_dim 256 --num_layers 2 --dropout 0.5 \
    --batch_size 32 --name IMG_ABC_TD_augmentation_dataset\
    ...
    >nohup_eval_lstm_IMG_ABC_TD_augmentation_dataset.out &