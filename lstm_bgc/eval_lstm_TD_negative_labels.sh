...
nohup python -u ./lstm_bgc_everygene/eval.py \
    ...
    --datasetPath ./data/NonBGC_TD_testing_dataset_negative.csv \
    --max_len 128 --hidden_dim 256 --num_layers 2 --dropout 0.5 \
    --batch_size 32 --name NonBGC_TD_testing_dataset_negative\
    ...
    >nohup_eval_lstm_NonBGC_TD_testing_dataset_negative.out &